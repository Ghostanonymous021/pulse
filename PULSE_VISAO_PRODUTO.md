...
**Actualizacao (18/07/2026):** selo de verificacao **pago e opcional** (estilo Meta Verified), disponivel para pessoa e organizacao. Nao e gratuito em massa; nao e exigido no cadastro.

- **Preco:** 60 MZN no primeiro mes (promo), 150 MZN/mes a seguir, via M-Pesa.
- **Badges distintos:** pessoa = check azul; organizacao = check em contorno quadrado (clareza institucional).
- **Regra inegociavel:** o selo **nunca** altera o score do algoritmo do feed principal. Unico boost de visibilidade: **Explorar/Descobre**.
- **Beneficios org extra:** destaques semanais 3→6, estatisticas basicas, multiplos admins.
- Integridade continua a basear-se em grafo social, auto-declaracao e denuncia.
